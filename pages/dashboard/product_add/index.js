...
const ProductAdd = props => {
    ...
    const handleSaveProduct = async () => {
        try {
            dispatch(addProductObject(addProduct))
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={2}>
                                            <TextField
                                                ...
                                                defaultValue={
                                                    addProduct.price
                                                        ? numberInputFormat(addProduct.price?.toString())
                                                        : ''
                                                }
                                                onChange={handleEditOnchage}
                                            />
                                        ...
                                        <Grid item xs={2}>
                                            <TextField
                                                ...
                                                name='compare_price'
                                                defaultValue={
                                                    addProduct.compare_price
                                                        ? numberInputFormat(addProduct.compare_price?.toString())
                                                        : ''
                                                }
                                                onChange={handleEditOnchage}
                                            />
